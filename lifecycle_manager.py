...
class ServiceExampleSettingsLifecycleManager(BaseLifecycleManager):
    ...
    def __init__(self, plugins_base_dir: str = None):
        ...
        self.plugin_data = {
            ...
            "compatibility": "1.0.0",
            "scope": "ServiceExampleSettings",
            "bundle_method": "webpack",
            "bundle_location": "dist/remoteEntry.js",
            "is_local": False,
            "long_description": "A comprehensive example demonstrating how to use the Settings Service in BrainDrive plugins for configuration management. Shows settings retrieval, updating, and change event handling patterns.",
        ...
        # Define module data for the simple theme selector demo
        self.module_data = [
            {
                "name": "ThemeSelector",
                "display_name": "Theme Selector Demo",
                "description": "Simple demo showing how to get and set theme settings using the Settings Service Bridge",
                "icon": "Palette",
                "category": "examples",
                "priority": 1,
                "props": {
                ...
                "tags": ["settings demo", "theme", "example"]
            }
        ]
    ...
    async def update_plugin(self, user_id: str, db: AsyncSession, new_version_manager: 'ServiceExampleSettingsLifecycleManager') -> Dict[str, Any]:
...
async def install_plugin(user_id: str, db: AsyncSession, plugins_base_dir: str = None) -> Dict[str, Any]:
    manager = ServiceExampleSettingsLifecycleManager(plugins_base_dir)
...
async def update_plugin(user_id: str, db: AsyncSession, new_version_manager: 'ServiceExampleSettingsLifecycleManager', plugins_base_dir: str = None) -> Dict[str, Any]:
    old_manager = ServiceExampleSettingsLifecycleManager(plugins_base_dir)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        manager = ServiceExampleSettingsLifecycleManager()
